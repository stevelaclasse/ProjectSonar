	...
	protected void extractingAnalyseResultsFromSonarQubeServerIntoExcelFile() throws Exception {
		...
		//System.out.println(json);
		 ...
		 List<Map<String, String>> allComponents=new ArrayList<Map<String, String>>();
	        ...
	        String[] sheetTitle={"PROJECTNAME", "BRANCH_COVERAGE", "LINE_COVERAGE","COVERAGE","TESTS","CODE_SMELLS","MAINTAINABILITY_RATING ","TECHNICAL_DEBT","DUPLICATED_LINES","DUPLICATED_LINES_DENSITY (%)","LINES","BUGS","RELIABILITY_RATING","RELIABILITY_REMEDIATION_EFFORT","COMPLEXITY"};
		 ...
		 for (int i=0;i<myComponents.components.size();i++) {
			 ...
			 http.setPath("api/measures/component?componentId="+myComponents.components.get(i).id+"&metricKeys=branch_coverage,"
			 		...
			 		+ "duplicated_lines_density,lines,bugs,reliability_rating,reliability_remediation_effort,complexity");
